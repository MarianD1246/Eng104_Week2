...
namespace DataTypes_Test
{
    public class CalculatorTests
    {
        ...
        [TestCase(9, -2, -18)]
        [TestCase(9, 0, 0)]
        public void WhenGivenTwoInts_Multiply_ReturnsCorrectAnswer(int num1, int num2, int expAnswer)
        {
            Assert.That(IntegerCalc.Multiply(num1, num2), Is.EqualTo(expAnswer));
        }
